          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row mt-3">
                ...
                <div class="col-5">
                  <input type="text" class="form-control" v-model="dataCompany.owner"/>
                </div>
              </div>
              <div class="row mt-2">
                <div class="col-2">Company Name</div>
                <div class="col-5">
                  <input type="text" class="form-control" v-model="dataCompany.name"/>
                </div>
              </div>
              <div class="row mt-2">
                <div class="col-2">Registartion Number</div>
                <div class="col-5">
                  <input type="text" class="form-control" v-model="dataCompany.registration_number"/>
                </div>
              </div>
              <div class="row mt-2">
                <div class="col-2">Phone Number</div>
                <div class="col-5">
                  <input type="text" class="form-control" v-model="dataCompany.phone"/>
                </div>
              </div>
              <div class="row mt-2">
                <div class="col-2">Address</div>
                <div class="col-5">
                  <input type="text" class="form-control" v-model="dataCompany.address" />
                </div>
              </div>
              <button class="btn btn-primary px-5 mt-5">Save</button>
